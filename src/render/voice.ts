 ...
 * 2. Every 7th refresh (refreshCount % 7 === 0) → time-of-day phrase if pool non-empty.
 * 3. Every 3rd refresh (refreshCount % 3 === 0) → idle phrase if pool non-empty.
 * 4. null.
 *
...
export function pickPhrase(
  ...
  // 2. Time-of-day phrase on every 7th refresh
  if (idx % 7 === 0) {
  ...
  // 3. Idle phrase on every 3rd refresh
  if (idx % 3 === 0) {
